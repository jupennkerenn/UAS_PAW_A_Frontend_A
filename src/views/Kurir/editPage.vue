            ...
            <form @submit.prevent="update">
              ...
              <div class="form-group mb-3">
                ...
                <select class="form-control" v-model="kurir.gender_kurir"
                  placeholder="Masukkan Gender Kurir">
                  <option disabled value="">Masukkan Gender Kurir</option>
                  <option>Pria</option>
...
export default {
  setup() {
    ...
    onMounted(() => {
      ...
      axios.get(`http://localhost:8000/api/kurirs/${route.params.id}`)
        .then(response => {
    ...
    function update() {
      ...
      axios.put(`http://localhost:8000/api/kurirs/${route.params.id}`, {
